...
export const sendMessage = async (content: string, projectId?: number, sessionId?: number, temp?: number, modelProvider: string = "groq", modelName: string = "llama-3.3-70b-versatile", historyLimit: number = 5, projectContextLimit: number = 2, contextSessionIds: number[] = [], title?: string) => {
